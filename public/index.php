...
<div class="container text-center p-3 mb-3">
  <div class="row align-items-center">
    <div class="col">
    <a href="?month=<?= $prevMonth ?>" class="btn btn-primary shadow-sm"><i class="bi bi-chevron-left"></i></a>
    </div>
    <div class="col">
    <h2><?php echo $date->format('Y.n'); ?></h2>
    </div>
    <div class="col">
    <a href="?month=<?= $nextMonth ?>" class="btn btn-primary shadow-sm"><i class="bi bi-chevron-right"></i></a>
    </div>
  </div>
</div>
